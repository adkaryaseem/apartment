...
.contact-section h2 {
  color: #ddd; /* Grayish-white color for contact details */
  font-size: 16px; /* Adjust font size for contact details */
  margin-bottom: 10px; /* Add margin below each contact detail */
}

.contact-section h3 {
  color: #ddd; /* Grayish-white color for the subheading */
  margin-top: 20px; /* Add margin above the subheading */
}
  ...
  <script defer src="/src/pages/home/index.js"></script>
</head>
